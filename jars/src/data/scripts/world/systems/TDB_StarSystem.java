...
public class TDB_StarSystem {
    ...
    public void generate(SectorAPI sector) {
        ...
        system.addRingBand(star, "misc", "rings_ice0", 256f, 1, Color.blue, 256f, 5400, 90f, Terrain.RING, "Starlight Ring");
        ...
        system.addRingBand(star, "misc", "rings_dust0", 256f, 1, Color.blue, 256f, 5000, 110f, Terrain.RING, "Stardust Ring");
        system.addRingBand(star, "misc", "rings_dust0", 256f, 1, Color.blue, 256f, 3000, 110f, Terrain.RING, "Stardust Ring");
        ...
        system.addRingBand(planet2, "misc", "rings_ice0", 256f, 1, Color.blue, 256f, 400, 90f, Terrain.RING, "Starlight Ring");
        //a new planet for people 一个新的星球（给势力
    ...
    public void addFleet(SectorEntityToken rock) {
        ...
        if (customFleet != null) {
            ...
            //设置舰队行为：巡逻并拦截玩家
            customFleet.addAssignment(FleetAssignment.PATROL_SYSTEM, rock, Float.MAX_VALUE, "Cooing");
    ...
    public void addFleet2(SectorEntityToken rock) {
        ...
        if (customFleet != null) {
            ...
            //设置舰队行为：巡逻并拦截玩家
            customFleet.addAssignment(FleetAssignment.PATROL_SYSTEM, rock, Float.MAX_VALUE, "On patrol");
            customFleet.addAssignment(FleetAssignment.INTERCEPT, null, Float.MAX_VALUE, "Intercepting the player");
            customFleet.setName("Synthlight Task Force");
