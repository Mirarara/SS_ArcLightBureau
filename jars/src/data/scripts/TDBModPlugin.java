...
public class TDBModPlugin extends BaseModPlugin {
    ...
    public void onApplicationLoad() {
        ...
        if (!hasLazyLib) {
            throw new RuntimeException("TDB requires LazyLib!");
        }
        boolean hasMagicLib = getSettings().getModManager().isModEnabled("MagicLib");
        if (!hasMagicLib) {
            throw new RuntimeException("TDB requires MagicLib!");
        }
        ...
        if (hasGraphicLib) {
            ...
            Global.getLogger(TextureData.class).log(Level.ERROR,"Required mods detected");
        }else {
            Global.getLogger(TextureData.class).log(Level.ERROR,"Required mods not detected");
        }
    }
